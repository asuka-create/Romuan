# 美酒館 商品トラッカー (LINE GIFT)

LINE GIFT のストア「美酒館」の**全商品**を毎日自動で取得し、
新商品を検出してリスト化・Web公開するツールです。
（`KEYWORD` 環境変数で「マッコリ」等の絞り込みも可能）
